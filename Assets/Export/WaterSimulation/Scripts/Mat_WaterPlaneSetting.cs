...
[ExecuteInEditMode]
public class Mat_WaterPlaneSetting : MonoBehaviour {
public bool m_DisablePixelLights = true;
	...
	public RenderScale m_renderScale = RenderScale.Tri;
	protected RenderScale _renderScale = RenderScale.Tri;
	public bool CopyClearFlag = true;
	...
	protected float _blursize = 2;
	protected int _blurIteration = 1;
	protected int _downSample = 1;
	...
	bool BlurParamCheck(){
		if(BlurIteration != _blurIteration) return true;
		if(BlurSize 	 != _blursize)		return true;
		if(DownSample 	 != _downSample)	return true;
