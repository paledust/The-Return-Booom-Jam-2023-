...
Shader "New Amplify Shader"
{
	...
	SubShader
	{
		...
		{
			float gradientNoise1 = GradientNoise(i.uv_texcoord,10.0);
			gradientNoise1 = gradientNoise1*0.5 + 0.5;
			float3 temp_cast_0 = (gradientNoise1).xxx;
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;2;-678,-61.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;1;-418,-52.5;Inherit;True;Gradient;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;10;False;1;FLOAT;0
WireConnection;0;0;1;0
WireConnection;1;0;2;0
ASEEND*/
//CHKSM=73773EF41AD3D6A082D9A28CB7C825C5374A8F0D